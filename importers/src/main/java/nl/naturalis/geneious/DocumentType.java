...
/**
 * Symbolic constants for document types that are relevant to the Naturalis plugin. The symbolic constants are mapped to actual Geneious
 * document type that gets created within the database.
 */
public enum DocumentType {
   ...
   * DefaultNucleotideSequence document with some dummy default values (e.g. "NNNNNNNNNN" for the nucleotide sequence). It might be
   * conceptually cleaner and possibly also slightly more performant to simply create a {@link TextDocument}, which is another type of
