 ...
 * <table>
 * <tr>
 * <td>Date 08 august 2016 Company Naturalis Biodiversity Center City Leiden Country Netherlands
 * </td>
 * </tr>
 * </table>
 * <p>
 ...
 * <tr>
 * <td>Date: 24 august 2016</td>
 * </tr>
 * <tr>
 * <td>Company: Naturalis Biodiversity Center</td>
 * </tr>
 * <tr>
 * <td>City: Leiden</td>
 * </tr>
 ...
 * Classes: - LimsImportAB1Update "Plugin Split name" - LimsImportBold "Plugin Bold" - LimsImportCRS
 * "Plugin CRS" - LimsImporSamples "Plugin Samples"</td>
 * </tr>
 * </table>
 * 
...
public class LimsImportAB1Plugin extends GeneiousPlugin {
   ...
   * 
   * @return Return "All naturalis files" in the dialog screen tos elect a Csv file
   * @see LimsImportAB1Plugin
   */
  ...
  public DocumentAction[] getDocumentActions() {
    return new DocumentAction[] {new LimsSplitName(), new LimsImportCRS(), new LimsImportBold(),
        new LimsImportSamples(), new SampleSheetDocumentAction()};
  }
  ...
  public DocumentType[] getDocumentTypes() {
    return new DocumentType[] {
        new DocumentType<LimsSamplesFields>("Samples document", LimsSamplesFields.class, null)};
  }
}
